...
public:
    ...
    static constexpr DWORD _MSR_MTRR_CAP = 0x000000FEUL;
    static constexpr DWORD _MSR_SYSENTER_CS = 0x00000174UL;
    static constexpr DWORD _MSR_SYSENTER_ESP = 0x00000175UL;
    static constexpr DWORD _MSR_SYSENTER_EIP = 0x00000176UL;
    static constexpr DWORD _MSR_MCG_CAP = 0x00000179UL;
    static constexpr DWORD _MSR_MCG_STATUS = 0x0000017AUL;
    static constexpr DWORD _MSR_MCG_CTL = 0x0000017BUL;
    static constexpr DWORD _MSR_DBG_CTL = 0x000001D9UL;
    static constexpr DWORD _MSR_BR_FROM = 0x000001DBUL;
    static constexpr DWORD _MSR_BR_TO = 0x000001DCUL;
    static constexpr DWORD _MSR_LAST_EXCP_FROM_IP = 0x000001DDUL;
    static constexpr DWORD _MSR_LAST_EXCP_TO_IP = 0x000001DEUL;
    static constexpr DWORD _MSR_MTRR_DEF_TYPE = 0x000002FFUL;
    static constexpr DWORD _MSR_U_CET = 0x000006A0UL;
    static constexpr DWORD _MSR_S_CET = 0x000006A2UL;
    static constexpr DWORD _MSR_XSS = 0x00000DA0UL;
    static constexpr DWORD _MSR_APIC_ID = 0x00000802UL;
    static constexpr DWORD _MSR_APIC_VERSION = 0x00000803UL;
    static constexpr DWORD _MSR_APIC_TPR = 0x00000808UL;
    static constexpr DWORD _MSR_APIC_PPR = 0x0000080AUL;
    static constexpr DWORD _MSR_APIC_EOI = 0x0000080BUL;
    static constexpr DWORD _MSR_APIC_LDR = 0x0000080DUL;
    static constexpr DWORD _MSR_APIC_SVR = 0x0000080FUL;
    static constexpr DWORD _MSR_APIC_ESR = 0x00000828UL;
    static constexpr DWORD _MSR_APIC_SELF_IPI = 0x0000083FUL;
    static constexpr DWORD _MSR_FS_BASE = 0xC0000100UL;
    static constexpr DWORD _MSR_GS_BASE = 0xC0000101UL;
    static constexpr DWORD _MSR_KERNEL_GS_BASE = 0xC0000102UL;
    static constexpr DWORD _MSR_TSC_AUX = 0xC0000103UL;
    static constexpr DWORD _MSR_STAR = 0xC0000081UL;
    static constexpr DWORD _MSR_VM_CR = 0xC0010114UL;
    static constexpr DWORD _MSR_LSTAR = 0xC0000082UL;
    static constexpr DWORD _MSR_CSTAR = 0xC0000083UL;
    static constexpr DWORD _MSR_SYSCALL_FLAG_MASK = 0xC0000084UL;
    ...
    static constexpr DWORD _MSR_PREFETCH_CONTROL = 0xC0000108UL;
    static constexpr DWORD _MSR_SYS_CFG = 0xC0010010UL;
    static constexpr DWORD _MSR_HWCR = 0xC0010015UL;
    static constexpr DWORD _MSR_TOP_MEM = 0xC001001AUL;
    static constexpr DWORD _MSR_TOM2 = 0xC001001DUL;
